...
*/
        ...
        public class Mathf
        {
            ...
            public static int Abs(int a) { return (int)Math.Abs(a); }
            public static int Max(int a, int b) { return (int)Math.Max(a, b); }
            public static int Min(int a, int b) { return (int)Math.Min(a, b); }
        }
        ...
        public MaxRectPacker(int width, int height, bool rotations = true)
        {
